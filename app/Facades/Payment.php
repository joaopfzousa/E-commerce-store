...
{
    public static function getPaymentReference($entity, $sub_entity, $value, $order_id)
    {
        return self::GenerateMbRef($entity, $sub_entity, $order_id, $value);
    }
    ...
    private static function GenerateMbRef($ent_id, $subent_id, $order_id, $order_value)
    {
        $chk_val = 0;
